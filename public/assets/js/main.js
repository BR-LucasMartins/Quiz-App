...
$("#easy_label").click(function() {
    if ($("#easy").prop("checked")) {
      $(".radio-easy").addClass( "radio-actived" );
      $(".radio-hard").removeClass( "radio-actived" );
      $(".radio-normal").removeClass( "radio-actived" );
    }
  });

  $("#normal_label").click(function() {
    if ($("#normal").prop("checked")) {
      $(".radio-normal").addClass( "radio-actived" );
      $(".radio-hard").removeClass( "radio-actived" );
      $(".radio-easy").removeClass( "radio-actived" );
    }
  });

  $("#hard_label").click(function() {
    if ($("#hard").prop("checked")) {
      $(".radio-hard").addClass( "radio-actived" );
      $(".radio-easy").removeClass( "radio-actived" );
      $(".radio-normal").removeClass( "radio-actived" );
    }
  });
  ...
  $("#difficulty").change(function(){
	  var x = $('#difficulty option:selected').val();
